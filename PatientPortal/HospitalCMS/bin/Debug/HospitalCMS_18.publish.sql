...
END
GO
PRINT N'Altering [dbo].[usp_PostStateHistory]...';


GO
ALTER PROCEDURE [dbo].[usp_PostStateHistory]
(
	@PostId INT	
)
AS BEGIN
...
END
GO
PRINT N'Altering [dbo].[usp_PostStateHistory_Transaction]...';


GO
ALTER PROCEDURE [dbo].[usp_PostStateHistory_Transaction]
	@Action CHAR(1) = 'I',
	@PostId INT,
	@WorkflowStateId TINYINT,
	@UserId INT,
