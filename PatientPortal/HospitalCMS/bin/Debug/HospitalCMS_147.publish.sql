...
GO
PRINT N'Altering [dbo].[usp_spa_Category]...';


GO
ALTER PROCEDURE [dbo].[usp_spa_Category]
	@ParentId TINYINT
AS BEGIN
	SET NOCOUNT ON
...
END
GO
PRINT N'Altering [dbo].[usp_spa_CategoryDept]...';


GO
ALTER PROCEDURE [dbo].[usp_spa_CategoryDept]
