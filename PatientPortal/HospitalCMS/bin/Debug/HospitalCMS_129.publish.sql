...
GO
PRINT N'Altering [dbo].[PostStateHistory]...';


GO
ALTER TABLE [dbo].[PostStateHistory] ALTER COLUMN [UserId] NVARCHAR (128) NOT NULL;
...
GO
PRINT N'Refreshing [dbo].[usp_PostStateHistory]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[usp_PostStateHistory]';


GO
PRINT N'Refreshing [dbo].[usp_PostStateHistory_Transaction]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[usp_PostStateHistory_Transaction]';
