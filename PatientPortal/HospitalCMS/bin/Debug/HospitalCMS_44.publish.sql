...
AS BEGIN
	BEGIN TRY
		...
		ELSE IF @languageCode = '' AND @PostId > 0
			SELECT p.Id, 
			t.Title as TitleTrans, c.Name as CategoryName, p.PublishDate,
			p.Author, t.[Description] as DescriptionTrans, t.Detail,
			ps.Canonical,
			ps.Title as TitleSEO, ps.[Description] as DescriptionSEO, ps.MetaRobotIndex
