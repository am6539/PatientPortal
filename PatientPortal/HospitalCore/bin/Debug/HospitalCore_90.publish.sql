...
GO
ALTER TABLE [dbo].[QA] ALTER COLUMN [Answer] NVARCHAR (MAX) NULL;

ALTER TABLE [dbo].[QA] ALTER COLUMN [DoctorId] NVARCHAR (128) NULL;


GO
PRINT N'Altering [dbo].[usp_QA]...';


GO
ALTER PROC [dbo].[usp_QA]
	@Id INT
AS BEGIN
	SET NOCOUNT ON
