...
GO
ALTER TABLE [dbo].[Appointment] DROP COLUMN [Medicine];


GO
ALTER TABLE [dbo].[Appointment] ALTER COLUMN [Date] DATE NOT NULL;

ALTER TABLE [dbo].[Appointment] ALTER COLUMN [Time] INT NOT NULL;
