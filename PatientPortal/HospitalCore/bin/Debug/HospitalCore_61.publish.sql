...
GO
PRINT N'The following operation was generated from a refactoring log file b46a7ed8-72dc-4754-8c20-a8fed9dd3ffb';

PRINT N'Rename [dbo].[UserProfile].[Descriptions] to Description';


GO
EXECUTE sp_rename @objname = N'[dbo].[UserProfile].[Descriptions]', @newname = N'Description', @objtype = N'COLUMN';
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'b46a7ed8-72dc-4754-8c20-a8fed9dd3ffb')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('b46a7ed8-72dc-4754-8c20-a8fed9dd3ffb')
