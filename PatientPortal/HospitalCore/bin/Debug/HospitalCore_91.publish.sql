...
GO
PRINT N'Altering [dbo].[QA]...';


GO
ALTER TABLE [dbo].[QA] ALTER COLUMN [Answer] NVARCHAR (MAX) NOT NULL;

ALTER TABLE [dbo].[QA] ALTER COLUMN [DoctorId] NVARCHAR (128) NOT NULL;
...
GO
PRINT N'Refreshing [dbo].[usp_QA_Transaction]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[usp_QA_Transaction]';


GO
PRINT N'Refreshing [dbo].[usp_spa_QA]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[usp_spa_QA]';
