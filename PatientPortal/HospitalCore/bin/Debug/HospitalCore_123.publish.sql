...
GO
PRINT N'Altering [dbo].[usp_SystemNotification_Transaction]...';


GO
ALTER PROCEDURE [dbo].[usp_SystemNotification_Transaction]
	@Action CHAR(1) = 'I',
	@Id INT,
	@Detail NVARCHAR(300) = '',
...
BEGIN
	...
	DECLARE @result INT = 0, @PresentDate VARCHAR(10), @Time VARCHAR(8)
		...
		BEGIN TRAN;
			IF(@Action = 'I')
				BEGIN
					...
					VALUES(@Detail, @PresentDate, @Time, @SendFrom, @Link)
					SET @result = 1
				END
			ELSE
				BEGIN
					UPDATE [dbo].[SystemNotification]
					SET		Detail = @Detail, [Date] = @PresentDate,
