...
GO
PRINT N'Dropping [dbo].[usp_Message_Transaction]...';


GO
DROP PROCEDURE [dbo].[usp_Message_Transaction];


GO
PRINT N'Dropping [dbo].[IntList]...';
...
CREATE TYPE [dbo].[IntList] AS TABLE (
    [Item] INT NOT NULL PRIMARY KEY NONCLUSTERED HASH ([Item]) WITH (BUCKET_COUNT = 131072))
