...
(
	...
	@AppointmentIntervalTime TINYINT = 15
)
AS BEGIN
	SET NOCOUNT ON
	SET TRANSACTION ISOLATION LEVEL READ COMMITTED
	...
	BEGIN TRY
		...
		ELSE
		BEGIN
			INSERT INTO [dbo].[Setting] VALUES(@Title, @Description, @Keyword, @Membership, @DefaultRole, @LoginURL, @LockedIPNoteDefault, @IsSaveCanceledAppointment, @AppointmentIntervalTime)
		END
