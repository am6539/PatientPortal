...
namespace PatientPortal.CMS.Controllers
{
    ...
    public class PostController : Controller
    {
        ...
        public PostController(IUserSession userSession)
        {
        ...
        public async Task<ActionResult> OtherLanguages(int postId, byte languageId)
        {
            ...
            var defaultPostTran = new PostTranViewModel() { PostId = postId };
            ...
            if (dataCatg != null)
            {
                ...
                if (languageId != 0)
                {
                    apiUrl = APIProvider.APIGenerator(controllerName, "PostTranBy", new List<string> { "postId", "languageId" }, true, postId, languageId);
                }
                else if (defaultLanguage != null)
                {
                    apiUrl = APIProvider.APIGenerator(controllerName, "PostTranBy", new List<string> { "postId", "languageId" }, true, postId, defaultLanguage.Id);
                }
