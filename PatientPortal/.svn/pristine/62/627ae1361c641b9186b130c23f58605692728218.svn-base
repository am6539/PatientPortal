...
namespace PatientPortal.Internal.Common
{
    public class ValueConstant
    {
        ...
        public const string IMAGE_DEPARTMENT_PATH = "~\\Assets\\images\\Department";
        ...
        public const string PATH_DOCS = "~/Assets/docs/";

        // Change password
        public const string INCORRECT_PASSWORD = "Incorrect password.";

        // Appointment don't have physicianId
        public const string PHYSICIAN_EMPTY = "Chưa xác định";
