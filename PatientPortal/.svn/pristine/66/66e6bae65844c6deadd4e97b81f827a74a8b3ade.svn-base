...
namespace PatientPortal.API.CMS
{
    ...
    public class DomainToViewModelMappingProfile : Profile
    {
        public DomainToViewModelMappingProfile()
        {
            ...
            CreateMap<GalleryStore, GalleryStoreViewModel>();
            CreateMap<AccessPost, AccessPostViewModel>();
        }
    }
    public class ViewModelToDomainMappingProfile : Profile
    {
        public ViewModelToDomainMappingProfile()
        {
            ...
            CreateMap<CMSConfigurationViewModel, CMSConfiguration>();
            CreateMap<SliderViewModel, Slider>();
            CreateMap<AdvertiseViewModel, Advertise>();
            CreateMap<GalleryViewModel, Gallery>();
            CreateMap<GalleryStoreViewModel, GalleryStore>();
            CreateMap<AccessPostViewModel, AccessPost>();
        }
    }
}