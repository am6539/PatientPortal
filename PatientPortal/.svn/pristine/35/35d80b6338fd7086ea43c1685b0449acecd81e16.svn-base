angular.module('spaPHCN').filter("dateFilter", function () {//2017-05-04T08:30:00 -> 04-05-2017
...
angular.module('spaPHCN').filter('dateEnNiceFilter', ['$filter', function ($filter) {
...
angular.module('spaPHCN').filter("dateNiceFilter", function () {//2017-05-04T08:30:00 -> 04 TH05 2017
    return function (item) {
        if (item != null) {
