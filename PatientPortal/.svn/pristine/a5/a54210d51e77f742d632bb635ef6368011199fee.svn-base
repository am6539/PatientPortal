...
// <copyright file="HtmlHelpers.cs" company="FIS" department="R&D">
...
namespace PatientPortal.Provider.Helpers
{
    public static class HtmlHelpers
    {
        ...
        public static MvcHtmlString IGroupTextBoxFor<TModel, TValue>(this HtmlHelper<TModel> htmlHelper,
            Expression<Func<TModel, TValue>> expression, bool isValidation = false, byte gridColLabel = 3, string placeHolder = "", object htmlAttributes = null)
        {
            var gridColInput = (gridColLabel >= 12 ? gridColLabel : (12 - gridColLabel));
            TagBuilder innerContainer = new TagBuilder("div");
            innerContainer.AddCssClass("col-md-" + gridColInput.ToString());
        ...
        public static MvcHtmlString IGroupTextBoxFor<TModel, TValue>(this HtmlHelper<TModel> htmlHelper,
            Expression<Func<TModel, TValue>> expression, bool isValidation = false, string placeHolder = null, byte gridColInput = 12, bool isInline = false, object htmlAttributes = null)
        {
            byte gridColLabel = Convert.ToByte((!isInline ? 12 : (gridColInput == 12 ? 12 : 12 - gridColInput)));
            TagBuilder innerContainer = new TagBuilder("div");
            innerContainer.AddCssClass("col-md-" + gridColInput.ToString());
            innerContainer.InnerHtml = htmlHelper.ITextBoxFor(expression, placeHolder, htmlAttributes).ToString();
        ...
        public static MvcHtmlString IGroupTextAreaFor<TModel, TValue>(this HtmlHelper<TModel> htmlHelper,
            Expression<Func<TModel, TValue>> expression, bool isValidation = false, byte rows = 3, string placeHolder = null, object htmlAttributes = null, byte gridColLabel = 3)
        {
        ...
        public static MvcHtmlString IGroupTextAreaFor<TModel, TValue>(this HtmlHelper<TModel> htmlHelper,
            Expression<Func<TModel, TValue>> expression, bool isValidation = false, byte rows = 3, byte gridColLabel = 12, string placeHolder = null, object htmlAttributes = null)
        {
        ...
        public static MvcHtmlString IGroupTextAreaFor<TModel, TValue>(this HtmlHelper<TModel> htmlHelper,
            Expression<Func<TModel, TValue>> expression, bool isValidation = false, byte rows = 3, string placeHolder = null, byte gridColInput = 12, bool isInline = false, object htmlAttributes = null)
        {

            var gridColLabel = Convert.ToByte(!isInline ? 12 :(gridColInput >= 12 ? gridColInput : (12 - gridColInput)));
            TagBuilder innerContainer = new TagBuilder("div");
            innerContainer.AddCssClass("col-md-" + gridColInput.ToString());
            innerContainer.InnerHtml = htmlHelper.ITextAreaFor(expression, rows, placeHolder, htmlAttributes).ToString();
        ...
        #region Button
        public static MvcHtmlString IGroupSubmitButton(this HtmlHelper htmlHelper, string title = "Submit", bool isSmallButton = true, bool navLeft = true, string id = null, object htmlAttributes = null, byte gridColl = 12)
        {
        ...
        public static MvcHtmlString IGroupSubmitButton(this HtmlHelper htmlHelper, string title = "Submit", string cancelUrl = null, byte gridColl = 12)
        {
            var navLeft = true;
            var isSmallButton = true;
            string id = null;
        ...
        public static MvcHtmlString IGroupSubmitButton(this HtmlHelper htmlHelper, string title = "Submit", bool isSmallButton = true, bool navLeft = true, string id = null, object htmlAttributes = null, byte gridColl = 12, string cancelUrl = null)
        {
            var gridOffset = (gridColl >= 12 ? 0 : (12 - gridColl));
        ...
        {
            TagBuilder tagBuilder = new TagBuilder("a");
            tagBuilder.InnerHtml = String.Format("<span class='fa {0}'></span> {1}", (icon == null ? "" : icon), (title == null || title.Length < 1 ? "Custom Button" : title));
            tagBuilder.MergeAttribute("href", (href != null && href.Length > 0 ? href : "#"));
            if (id != null)
        ...
        public static MvcHtmlString ICustomButton(this HtmlHelper helper, string title, string href = null, string icon = null, object htmlAttributes = null, string id = null, bool IsSmallButton = true, bool isPopupModal = false)
        {
            TagBuilder tagBuilder = new TagBuilder("a");
            tagBuilder.InnerHtml = String.Format("<span class='fa {0}'></span> {1}", (icon == null ? "": icon), (title == null || title.Length < 1 ? "Custom Button" : title));
            tagBuilder.MergeAttribute("href", (href != null && href.Length > 0 ? href : "#"));
        ...
        public static MvcHtmlString ICustomButton(this HtmlHelper helper, string title, string href = null, ColorBase color = ColorBase.Default , string icon = null, object htmlAttributes = null, string id = null, bool IsSmallButton = true, bool isPopupModal = false)
        {
            TagBuilder tagBuilder = new TagBuilder("a");
            tagBuilder.InnerHtml = String.Format("<span class='fa {0}'></span> {1}", (icon == null ? "" : icon), (title == null || title.Length < 1 ? "Custom Button" : title));
            tagBuilder.MergeAttribute("href", (href != null && href.Length > 0 ? href : "#"));
            ...
            var isHasClass = false;
            var className = HtmlAttributesBuilder(color, IsSmallButton);
             if(className.Length < 1) className = "btn btn-default " + (IsSmallButton ? "btn-sm" : "");
            if (isPopupModal)
            {
                className = (className.Contains("modal-link") ? className : className + " modal-link");
            }
        ...
        public static MvcHtmlString IGridButton(this HtmlHelper helper, string href, ActionButton type = ActionButton.View, string title = null, object htmlAttributes = null, bool isPopupModal = false)
        {
            ...
            if (!isPopupModal) className = className.Replace("modal-link", "");
        ...
        public static MvcHtmlString IGridButton(this HtmlHelper helper, string href, bool blankTarget = true, ActionButton type = ActionButton.View)
        {
            var htmlData = HtmlAttributesBuilder(type, true);
            TagBuilder tagBuilder = new TagBuilder("a");
            tagBuilder.InnerHtml = String.Format("<span class='fa {0}'></span>", htmlData["icon"]);
            tagBuilder.MergeAttribute("href", (href != null && href.Length > 0 ? href : "#"));
            if(blankTarget) tagBuilder.MergeAttribute("target", "_blank");

            var isHasClass = false;
            var className = htmlData["class"] + " btn-grid-action";
   
            var htmlAttributes = new { @class = className };
            isHasClass = true;
        ...
        public static MvcHtmlString IGroupDropDownListFor<TModel, TValue>(this HtmlHelper<TModel> htmlHelper,
            Expression<Func<TModel, TValue>> expression, IEnumerable<SelectListItem> selectList, string optionLabel = null, byte gridColLabel = 12, bool isValidation = false,
            object htmlAttributes = null)
        {
        ...
        public static MvcHtmlString IGroupFileUpload<TModel, TValue>(this HtmlHelper<TModel> htmlHelper,
            Expression<Func<TModel, TValue>> expression, byte gridColLabel = 3, string name = "fileUpload", string accept = "image/*", object htmlAttributes = null)
        {
        ...
        public static MvcHtmlString IFilesUpload(this HtmlHelper htmlHelper,
            string name = "fileUpload", string accept = "image/*", object htmlAttributes = null)
        {
            var attrs = HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes);
            ...
            StringBuilder html = new StringBuilder();
            string control = "<input type='file' name = '" + name + "' accept = '" + accept + "' multiple = 'multiple' ";
            foreach (var item in attrs)
            {
                control += item.Key + " = " + item.Value;
            }
        ...
        private static string HtmlAttributesBuilder(ColorBase color, bool isSmallButton = false)
        {
            var _class = string.Empty;

            switch (color)
            {
                case ColorBase.Alert:
                    _class = "btn btn-alert";
                    break;
                case ColorBase.Danger:
                    _class = "btn btn-danger";
                    break;
                case ColorBase.Info:
                    _class = "btn btn-info";
                    break;
                case ColorBase.Inverse:
                    _class = "btn btn-inverse";
                    break;
                case ColorBase.Primary:
                    _class = "btn btn-primary";
                    break;
