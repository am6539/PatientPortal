    ...
    public class AutoMapperConfig
    {
        ...
        public class DomainToViewModelMappingProfile : Profile
        {
            public DomainToViewModelMappingProfile()
            {
                ...
                CreateMap<PatientPortal.Domain.Models.CORE.OM.SystemNotification, SystemNotificationViewModel>();
            }
        }
        public class ViewModelToDomainMappingProfile : Profile
        {
            public ViewModelToDomainMappingProfile()
            {
                ...
                CreateMap<AppointmentLogViewModel, AppointmentLogEdit>();
                ...
                CreateMap<SystemNotificationViewModel, PatientPortal.Domain.Models.CORE.OM.SystemNotification>();
            }
        }
    }
}