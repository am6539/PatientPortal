...
namespace PatientPortal.API.Core
{
    public class AutofacConfig
    {
        public static IContainer RegisterDependencies()
        {
            ...
            builder.RegisterType<UserNotificationRepoImpl>().As<IUserNotificationRepo>().InstancePerRequest();
            builder.RegisterType<UserNotificationImpl>().As<IUserNotification>().InstancePerRequest();

            builder.RegisterType<DashboardRepoImpl>().As<IDashboardRepo>().InstancePerRequest();
            builder.RegisterType<DashboardImpl>().As<IDashboard>().InstancePerRequest();

            builder.RegisterType<SystemNotificationRepoImpl>().As<ISystemNotificationRepo>().InstancePerRequest();
            builder.RegisterType<SystemNotificationImpl>().As<ISystemNotification>().InstancePerRequest();
