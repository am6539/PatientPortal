...
namespace PatientPortal.DataAccess.CORE
{
    public class ModuleImpl : IModule
    {
        ...
        {
            return await _adapterPattern.SingleExecuteQuery<bool>(para, "usp_Module_CheckExistTitle", DataConfiguration.instanceCore);
        ...
        {
            return await _adapterPattern.SingleExecuteQuery<bool>(para, "usp_Module_CheckIsUsed", DataConfiguration.instanceCore);
        }
    }
}
